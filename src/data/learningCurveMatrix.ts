...
export const STYLE_PROGRESSION_MATRIX = {
  ...
  repeat: {
    // Repeat Style (Within 3 Month in the same line)
    // Light weight: 0 - 30 Min
    light: [
      25, 35, 45, 55, 60, 60, 61, 61, 62, 62,
