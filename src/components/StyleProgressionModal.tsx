                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-2 font-sans text-left text-[10px] text-[#527078]">
                        ...
                        {dayNum === 10 && 'Batch efficiency regular target locked'}
          ...
          <div className="p-4 rounded-xl bg-[#fff8e8] border border-[#f5e0b0] text-xs text-[#8c531b] flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="leading-relaxed">
                1. <strong>Repeat Style Rule:</strong> Any style reintroduced on the same sewing line within 3 months begins on the <strong>Repeat Style Curve</strong> with elevated regular efficiency.
                <br />
